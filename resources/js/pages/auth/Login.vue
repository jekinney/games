...
<template>
    <AuthBase title="Log in to your account" description="Enter your email and password below to log in">
        ...
        <div class="mb-6 grid gap-3">
            <Button type="button" variant="outline" class="w-full" @click="loginWithSocial('github')">
                <Github class="mr-2 h-4 w-4" />
                Continue with GitHub
            </Button>

            <div class="grid grid-cols-2 gap-3">
                <Button type="button" variant="outline" @click="loginWithSocial('google')">
                ...
                <Button type="button" variant="outline" @click="loginWithSocial('facebook')">
