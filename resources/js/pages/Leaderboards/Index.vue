                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                        <div
                            ...
                            :key="game.id"
                            class="group transform cursor-pointer rounded-lg border border-white/20 bg-white/10 backdrop-blur-sm transition-all hover:scale-105 hover:bg-white/20"
                        ...
                        >
                            <div class="p-6">
                                <div class="flex items-center space-x-4">
                                    ...
                                    <div class="flex-1">
                                        <h3 class="text-lg font-bold text-white transition-colors group-hover:text-purple-300">
                                            {{ game.name }}
                                        </h3>
                                        <p class="text-sm text-purple-200 capitalize">{{ game.category }}</p>
                                    </div>
