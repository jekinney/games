<template>
    <div class="memory-game-container">
        ...
        <div class="game-controls">
            <button v-if="!gameStarted" @click="startGame" class="btn btn-primary">Start Game</button>
            <button v-if="gameStarted && !gameOver" @click="pauseGame" class="btn btn-secondary">
                {{ isPaused ? 'Resume' : 'Pause' }}
            </button>
            <button v-if="gameOver" @click="restartGame" class="btn btn-primary">Play Again</button>
            <button @click="resetGame" class="btn btn-danger">Reset</button>
        </div>
