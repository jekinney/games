...
class MemoryTestGameSeeder extends Seeder
{
    ...
    public function run(): void
    {
        Game::create([
            ...
            'thumbnail_url' => 'https://via.placeholder.com/300x200/667eea/ffffff?text=Memory+Test',
            'image_url' => 'https://via.placeholder.com/800x400/667eea/ffffff?text=Memory+Test+Game',
